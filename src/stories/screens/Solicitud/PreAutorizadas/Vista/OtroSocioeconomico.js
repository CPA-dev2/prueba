      ...
      <View>
        ...
        <View style={styles.bottomDatos}>
          <View style={styles.bottomSeccion}>
            ...
            <View style={{ borderBottomColor: colors.Negro, borderBottomWidth: .75}}>
              <Picker style={{...styles.picker, color:colors.Gris}} selectedValue={info.ocupacion.toString()} enabled={false}>
        ...
        <View style={styles.bottomDatos}>
          ...
          <View style={styles.bottomSeccion}>
            ...
            <View>
              <View style={{ borderBottomColor: colors.Negro, borderBottomWidth: .75}}>
                <Picker style={{...styles.picker, color:colors.Gris}} selectedValue={info.periocidad_ingresos.toString()} enabled={false}>
