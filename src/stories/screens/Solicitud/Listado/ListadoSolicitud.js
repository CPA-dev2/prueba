...
const ListadoSolicitud = (props) => {
  ...
  return (
    <Box flex={1}>
      {search ? (
        <Navbar regresar={() => navigation.popToTop()} titulo={"Solicitudes pendientes"} navigation={navigation} imagen={fotos.lupa} cerrar={toggleNavbar}/>
      ) : (
